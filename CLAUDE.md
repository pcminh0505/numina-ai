...
|---|---|---|
| NumerologyReading | Celo Sepolia | `VITE_READING_CONTRACT_TESTNET` after `pnpm deploy:contract` |
| NumerologyReading | Celo mainnet | `VITE_READING_CONTRACT_MAINNET` after `DEPLOY_CHAIN=mainnet pnpm deploy:contract` |
